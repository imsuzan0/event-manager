  ...
  const [events, setEvents] = useState([
    {
      ...
      description: "Join us for the biggest React conference of the year! Learn about the latest features, best practices, and connect with fellow developers. This is a must-attend event for anyone working with React.",
    ...
    },
    {
      ...
      description: "A comprehensive wellness workshop focusing on mental health, nutrition, and physical fitness. Expert speakers will share insights on maintaining a healthy work-life balance in the tech industry.",
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Connect with your community through exciting events in tech, health, and more
          </p>
        </div>
        <EventFeed 
          events={events} 
